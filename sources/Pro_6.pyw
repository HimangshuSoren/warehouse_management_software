...
def add_btn():
    global R
    if R > 0 :
        messagebox.showinfo("Information",message = "A record with same ID already exist a new record will be added with for the given information, Do you want to continue ")
    def add_btn_new():
